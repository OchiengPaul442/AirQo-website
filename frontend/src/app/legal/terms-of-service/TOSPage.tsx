  ...
  const sections = [
    {
      ...
      content: (
        <ol>
          ...
          <li>
            If you register with our platform, submit any material to our
            platform or use any of our platform services, we will ask you to
            expressly agree to these terms and conditions.
          </li>
          <li>
            Our platform uses cookies; by using our platform or agreeing to
    ...
    },
    {
      ...
      content: (
        <>
          <ol>
            <li>
              Copyright (c) 2020 AirQo, College of Computing and Information
          ...
          <p>
            ...
            copyright and other intellectual property rights in our platform and
            the material on our platform; and
          </p>
          <p>
            b. All the copyright and other intellectual property rights in our
            platform and the material on our platform are reserved.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ol>
            ...
            <li>
              If observational data are used for analyses, displayed on web
              pages, or used for other programs or products, the analysis
              results, displays, or products must indicate that these data are
              indicative and not fully verified or validated;
            </li>
            <li>
              Publications, analyses, products, presentations, and/or derived
              information that rely on these data must give attribution to the
              originating data provider named on the data as well as AirQo,
              subject to the other provisions of these terms and conditions.
            </li>
          </ol>
          <p>
            <b>4.2 You may only use our platform for your own personal use,</b>{' '}
            academic research, government policy research and development,
            charitable and public awareness raising, and you must not use our
          ...
          <p>
            ...
            <br />
            republish material from our platform (including republication on
            another platform); sell, rent or sub-license material from our
            platform; or exploit material from our platform for a commercial
            purpose.
          </p>
          <p>
            <b>4.6 Notwithstanding Section 4.5,</b> you may redistribute our
            newsletter or blog posts in print and electronic form to any person.
          </p>
          <p>
            <b>
              4.7 We reserve the right to restrict access to areas of our
              platform,
            </b>{' '}
        ...
        <>
          ...
          <ol>
            ...
            <li>
              ...
              extraction and data harvesting) on or in relation to our platform
              without our express written consent or via registered use of our
              API or other data export, visualisation export or reporting tools
            ...
            <li>
              You must not use data collected from our platform to contact
              individuals, companies or other persons or entities unless
              specific links or contact details have been provided on the
              platform.
            </li>
          </ol>
        </>
    ...
    },
    {
      ...
      content: (
        <ol>
          <li>
            You may register for an account with our platform by completing and
            submitting the account registration form on our platform, and
            clicking on the verification link in the email that the platform
            will send to you.
          </li>
          <li>
            You must ensure that all the information you supply to us through
            our platform in relation to your intended use of our content and
            your affiliations is true, accurate, current, complete and
            non-misleading.
          </li>
          <li>
          ...
          <li>
            ...
            platform, unless you have that person&apos;s express permission to
            do so.
          </li>
        </ol>
      ),
    },
    {
      ...
      content: (
        <ol>
          <li>
            If you register for an account with our platform, we will provide
            you with, or you will be asked to choose a user ID and password.
          </li>
          <li>
            Your user ID must not be liable to mislead and must comply with the
            content rules set out in Section 10; you must not use your account
            or user ID for or in connection with the impersonation of any
            person.
          </li>
          ...
          <li>
            You are responsible for any activity on our platform arising out of
      ...
      content: (
        <ol>
          ...
          <li>
            ...
            person&apos;s legal rights, and must not be capable of giving rise
            to legal action against any person (in each case in any jurisdiction
      ...
      content: (
        <ol>
          <li>
            ...
            platform. The data available on the platform are indicative and
            while efforts are made to provide accurate data they are not fully
            verified or validated; these data are subject to change, error, and
            correction. The data and information are not presented as an
            official record
            <br />
            <br />
            the functionality or reliability of products in development and
            labelled as &apos;beta&apos; versions which are released for trial
            purposes only and may be discontinued at any time;
            <br />
            <br />
          ...
          <li>
            ...
            platform services, and to stop publishing our platform, at any time
            ...
            payment upon the discontinuance or alteration of any platform
            services, or if we stop publishing the platform.
          </li>
          <li>
            To the maximum extent permitted by applicable law and subject to
            Section 12.1, we exclude all representations and warranties relating
            to the subject matter of these terms and conditions, our platform
      ...
      content: (
        <ol>
          ...
          <p>
            ...
            12 and elsewhere in these terms and conditions:
          </p>
          ...
          <p>
            To the extent that our platform and the information and services on
            our platform are provided free of charge, we will not be liable for
      ...
      content: (
        <ol>
          ...
          <li>
            ...
            that they block your access to our platform;
          </li>
          <li>
      ...
      content: (
        <ol>
          ...
          <p>
            ...
            platform from the date of publication of the revised terms and
            conditions on the platform, and you hereby waive any right you may
    ...
    },
    {
      ...
      content: (
        <ol>
          ...
          <p>
            Our platform allows users to use the services of some third party
            applications such as Google maps or Open Street Map. When using
            these services users are bound by the providers Terms and Conditions
            and AirQo accepts no liability for user breech of these terms and
            conditions or the performance of these services.
          </p>
        </ol>
      ),
    },
    {
      ...
      content: (
        <ol>
          <p>
            Subject to Section 12.1, these terms and conditions, together with
            our privacy and cookies policy, shall constitute the entire
            agreement between you and us in relation to your use of our platform
            and shall supersede all previous agreements between you and us in
            relation to your use of our platform.
          </p>
        </ol>
      ),
    },
      ...
      content: (
        <ol>
          ...
          <p>
            ...
            to the non-exclusive jurisdiction of the courts of Uganda.
          </p>
        </ol>
      ),
    },
    {
      ...
      content: (
        <ol>
          <p>
            This platform is owned and operated by College of Computing and
            Information Sciences, Makerere University, Kampala, Uganda.
          </p>
          <p>
            Our principal place of business is at Software Systems Centre, Block
            B, Level 3, College of Computing and Information Sciences, Plot 56
            University Pool Road Makerere University, Kampala, Uganda.
          </p>
